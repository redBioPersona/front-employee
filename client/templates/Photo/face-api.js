(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var environment$1;
    function initialize() {
        environment$1 = initializeEnvironment();
    }
    function getEnv() {
        return environment$1;
    }
    function monkeyPatch(env) {
        environment$1 = environment$1 || initializeEnvironment();
                            ...
                            manifest.forEach(function (manifestGroupConfig, groupIndex) {
                                ...
                                manifestGroupConfig.weights.forEach(function (weightsEntry) {
                                    var rawDtype = (weightsEntry.quantization) ?
                                        ...
                                        weightsEntry.dtype;
                                    var weightsBytes = DTYPE_VALUE_SIZE_MAP$1[rawDtype] *
                        ...
                        case 1:
                            ...
                            groupIndicesToFetch.forEach(function (i) {
                                ...
                                weightsEntries.forEach(function (weightsEntry) {
                                    ...
                                    var nameToTensorMap = io.decodeWeights(byteBuffer, [weightsEntry.manifestEntry]);
    ...
    var NeuralNetwork = /** @class */ (function () {
        ...
        NeuralNetwork.prototype.load = function (weightsOrUrl) {
            console.log("weightsOrUrl:",weightsOrUrl);
            return __awaiter$1(this, void 0, void 0, function () {
                return __generator$1(this, function (_a) {
                    switch (_a.label) {
                        case 0:
